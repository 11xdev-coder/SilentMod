...
namespace SilentMod.Events
{
    public class Apocalypse
    {
        ...
        public static int[] invaders = {
            ModLoader.GetMod("SilentMod").NPCType("Doomsday_Bunny"),
            ModLoader.GetMod("SilentMod").NPCType("Doomsday_Zombie")
        };
        ...
        public static void StartApocalypse()
        {
            ...
            if (Main.invasionType == 0)
            {
                ...
                if (numPlayers > 0)
                {
                    ...
                    SilentNPCWorld.ApocalypseUp = true;
        ...
        public static void ApocalypseWarning()
        {
            string text = "";
            if (Main.invasionX == (double)Main.spawnTileX)
            {
                text = "Apocalypse is approaching!";
            }
            if (Main.invasionSize <= 0)
            {
                text = "Apocalypse ends.";
            }
        ...
        public static void UpdateApocalypse()
        {
            ...
            if (SilentNPCWorld.ApocalypseUp)
            {
                ...
                if (Main.invasionSize <= 0)
                {
                    SilentNPCWorld.ApocalypseUp = false;
                    ApocalypseWarning();
                    Main.invasionType = 0;
