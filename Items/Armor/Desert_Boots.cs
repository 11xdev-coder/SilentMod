...
namespace SilentMod.Items.Armor
{
	...
	public class Desert_Boots : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Desert Boots"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
